...
export const metadata = {
  title: 'Página não encontrada | Stela Finance',
};
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8f9fa] p-6 font-sans">
      <div className="max-w-md w-full text-center space-y-8">
        <div className="flex flex-col items-center gap-4">
          ...
          <h1 className="text-5xl font-medium text-[#1a1a1a] tracking-tighter italic">404</h1>
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#1a1a1a]/60 italic">Página não encontrada</p>
        </div>
